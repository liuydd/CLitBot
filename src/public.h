...
#ifndef _PUBLIC_H
#define _PUBLIC_H
//这里常数的数值我随便设置了，你们可以根据需要修改
extern const int MAX_OPS=100;
extern const int MAX_PROCS=100;
extern const int MAX_ROW=100;
extern const int MAX_COL=100;
extern const int MAX_LIT=100;
extern const int MAX_PATH_LEN=20;
// 位置类型，可用来表达机器人或灯所在位置 
struct Position { 
